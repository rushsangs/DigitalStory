...
public class PreconditionQuestion implements Question {
	...
	public void promptUser() {
		...
		boolean[][] matrix1 = new boolean[bA.length][meA.length];
		boolean[][] matrix2 = new boolean[mA.length][eA.length];
		...
		PreconditionFrame frame2 = new PreconditionFrame("alskjfs #1", bA, meA, matrix2);
